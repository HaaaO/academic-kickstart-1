+++
# Project title.
title = "Trust in Multi-Party Human-Robot Interaction"

# Date this page was created.
date = 2019-03-26T00:00:00

# Project summary to display on homepage.
summary = "Building computational model of trust for human-robot interaction in group therapy setting"
...
links = [
{icon_pack = "fas", icon="link", name="Detail", url = "http://robotics.usc.edu/interaction/projects/desc2.php?name=multiparty_support"}
]
...
See [Interaction Lab website](http://robotics.usc.edu/interaction/projects/desc2.php?name=multiparty_support)
